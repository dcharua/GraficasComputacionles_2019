...
function createSquare(gl) 
{
    ...
    var square = {buffer: buffer,vertSize: 3,nVerts: 4,primtype: gl.TRIANGLE_STRIP};
    return square;
}
...
function createTriangle(gl)
{
    ...
    var triangle = { buffer: buffer, vertSize: 3, nVerts: 3, primtype:gl.TRIANGLE_STRIP};
    return triangle;
}
...
function createRhombus(gl)
{
  ...
  // The resulting object contains the vertexbuffer, the size of the vertex structure (3 floats, x, y, z), the number of vertices to be drawn, the the primitive to draw.
  var rhombus = {buffer: buffer,vertSize: 3,nVerts: 4,primtype:gl.TRIANGLE_STRIP};
...
function createSphere(gl, radius)
{
    ...
    var sphere = {buffer: buffer,vertSize: 3,nVerts: vertices.length / 3,primtype: gl.TRIANGLE_FAN};
